...
public class TextUserInterface {
    ...
    public TextUserInterface(Scanner reader, Dictionary dictionary) {
        ...
        this.reader = reader;
        dictionary.add("add", "adds a word pair to the dictionary");
        dictionary.add("translate", "asks a word and prints its translation");
        dictionary.add("quit", "quits the text user interface");
    }
